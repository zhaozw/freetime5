...
class MDropCardStrategyXuezhan(MDropCardStrategy):
    """胡牌规则
    """
    def __init__(self):
        super(MDropCardStrategyXuezhan, self).__init__()
     
    def isChi(self, allTiles, chiTile, chiPatterns, leftTiles, tingResults, seatResponse, tingRule=None):
        '''
            默认能吃就吃
            allTiles - 当前玩家的所有手牌
            chiTile - 吃牌
    ...
    def isPeng(self, allTiles, pengTile, pengPatterns, leftTiles, tingResults, seatResponse, tingRule=None):
        '''
            默认能碰就碰
            allTiles - 当前玩家的所有手牌
            pengTile - 碰牌
    ...
    def isGang(self, allTiles, gangTile, gangSolution, leftTiles, tingResults, seatResponse, tingRule=None):
        '''
            默认能杠就杠
            allTiles - 当前玩家的所有手牌
            gangTile - 杠牌
        ...
        doQing, _ = self.doQingYiSe(allTiles, leftTiles)
        if doQing:
            # 清一色默认不开杠    
            return False
        else:
    ...
    def isTing(self, allTiles, dropTile, leftTiles, seatResponse=False):
        '''
        是否听牌
        '''
