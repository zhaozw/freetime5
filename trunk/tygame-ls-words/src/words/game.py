...
@author: lixi
'''
from words.plugins.srvroom.normal_room import TYNormalRoom
from words.plugins.srvtable.table import TYTable
from freetime5.util import ftlog
from tuyoo5.core import tygame, tyglobal
from words.plugins.srvroom import tyRoomConst
