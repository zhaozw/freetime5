...
'''
'''
from flipjoy.plugins.srvroom.room import TYRoom
from flipjoy.plugins.srvtable.table_observers import TYObservers
from flipjoy.plugins.srvtable.table_playerlist import TYPlayerList
from flipjoy.plugins.srvtable.table_seatlist import TYSeatList
from flipjoy.plugins.srvtable.table_state import TYTableState
...
class TYTable(object):
    ...
    @property
    def timerInfo(self):
        return self.__timerInfo

    @timerInfo.setter
    def timerInfo(self, value):
        self.__timerInfo = value
    ...
    @property
    def tableMsgId(self):
        return self.__tableMsgId

    @playersInfo.setter
    def tableMsgId(self, value):
        self.__tableMsgId = value
