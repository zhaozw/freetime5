...
from crosselimination.plugins.srvutil._private import _srvutil_handler
...
class CrossEliminationSrvUtil(typlugin.TYPlugin):
    ...
    def __init__(self):
        ...
        self.checkBindGame = self.basechecker.clone()
        self.checkBindGame.addCheckFun(check_MsgId)
